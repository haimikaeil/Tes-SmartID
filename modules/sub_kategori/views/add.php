				...
				<form action="<?=site_url($this->cname.'/do_tambah')  ?>" class="form-horizontal" method="POST" enctype="multipart/form-data">
					<div class="form-body">
						<div class="form-group">
							...
							<div class="col-md-4">
								<input class="form-control" type="text" name="sub_kategori" placeholder="<?=ucwords(str_replace('_', ' ', 'Isi sub_kategori'))?>" value="<?=@$this->session->flashdata('postdata')->sub_kategori?>" required/>
							</div>
						</div>
						<div class="form-group">
